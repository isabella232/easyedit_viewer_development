// alert("hello from init manifest");

if (typeof($) == 'undefined') $ = {};
if (typeof(EasyEditViewer) == 'undefined') EasyEditViewer = {};
if (typeof eev == 'undefined') eev = {};
  ...
  eev.consoler = {
    log: function(data) {
      eev.JSXEvent(data, "eev.consoler");
    }
  };

  eev.JSXEvent = function (payload, eventType) {
    try {
...
EasyEditViewer.toJSON = function(obj) {
    var t = typeof obj;
...
var $http_viewer = (function () {
  ...
  "object" != typeof JSON && (JSON = {}),
    function () {
      ...
      function quote(t) {
        return escapable.lastIndex = 0, escapable.test(t) ? '"' + t.replace(escapable,
          function (t) {
            var e = meta[t];
      ...
      function str(t, e) {
        ...
        switch (a && "object" == typeof a && "function" == typeof a.toJSON && (a = a.toJSON(t)),
          ...
          case "object":
            if (!a) return "null";
            if (gap += indent, f = [], "[object Array]" === Object.prototype.toString.apply(
              a)) {
            ...
            if (rep && "object" == typeof rep)
              for (u = rep.length, n = 0; u > n; n += 1) "string" == typeof rep[n] && (r = rep[
                n], o = str(r, a), o && f.push(quote(r) + (gap ? ": " : ":") + o));
            else
              for (r in a) Object.prototype.hasOwnProperty.call(a, r) && (o = str(r, a), o && f
                .push(quote(r) + (gap ? ": " : ":") + o));
            return o = 0 === f.length ? "{}" : gap ? "{\n" + gap + f.join(",\n" + gap) + "\n" +
              i + "}" : "{" + f.join(",") + "}", gap = i, o
        }
      ...
      "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function () {
          return isFinite(this.valueOf()) ? this.getUTCFullYear() + "-" + f(this
            .getUTCMonth() + 1) + "-" + f(this.getUTCDate()) + "T" + f(this.getUTCHours()) +
            ":" + f(this.getUTCMinutes()) + ":" + f(this.getUTCSeconds()) + "Z" : null
        }, Boolean.prototype.toJSON = this_value, Number.prototype.toJSON = this_value, String
        ...
        JSON.parse = function (text, reviver) {
          function walk(t, e) {
            ...
            if (o && "object" == typeof o)
              for (n in o) Object.prototype.hasOwnProperty.call(o, n) && (r = walk(o, n),
  ...
  return function (config) {
    ...
    if (!s.open(url.host + ':' + url.port, 'binary')) {
      ...
      throw 'can\'t connect to server. Check http lib line 129';
    }
    ...
    var contenttype = (http.headers["Content-Type"] || http.headers["content-type"] || '')
      .split(";");
    var charset = config.charset || (contenttype[1] ? /charset=(.*)/.exec(contenttype[1])[1] :
      null);
...
$._ext = {
  ...
  evalFiles: function(jsxFolderPath) {
    ...
    if (folder.exists) {
      ...
      var jsxFilesSorted = jsxFiles.sort(function(a, b) {
    ...
    // alert(jsxFilesSorted.toString());
      for (var i = 0; i < jsxFilesSorted.length; i++) {
        var jsxFile = jsxFilesSorted[i];
